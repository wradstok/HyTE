...
for k in range(args.freq,30000,args.freq):
    try:
        ...
        model_output_head = open(f'results/{args.model}/{args.eval_mode}_head_pred_{k}.txt')
        model_output_tail = open(f'results/{args.model}/{args.eval_mode}_tail_pred_{l}.txt')
